...
const CategoriesCard = ({ img, lable, info }) => {
  return (
    <div className="w-full flex justify-center ">
      <div className="max-w-[580px] w-full h-[300px] hover:bg-gradient-to-t hover:from-primary-black absolute z-10 cursor-pointer">
      ...
      <div className="max-w-[580px] w-full h-[300px]">
        <img
